...
/*------------------------------------
 ...
 -------------------------------------*/
void test1(){
Print("Test1 is for Exec syscall.\n", sizeof("Test3 is for multiprocess.\n")/sizeof(char), 0, 0);
Print("p1 process trying to exec.\n", sizeof("p1 process tring to exec.\n")/sizeof(char), 0, 0);
...
void test2(){
    ...
    Print("p2 process trying to exec.\n", sizeof("p2 process tring to exec.\n")/sizeof(char), 0, 0);
...
void test3(){
    ...
    Exec("../test/p1", sizeof("../test/p2")/sizeof(char));
    Exec("../test/p1", sizeof("../test/p2")/sizeof(char));
    Exec("../test/p1", sizeof("../test/p2")/sizeof(char));
    Exit(0);
...
void test4(){
    ...
    Yield();
    Yield();
    Print("\nTest4 is for multiprocess and multithread.\n", sizeof("\nTest3 is for multiprocess and multithread.\n")/sizeof(char), 0, 0);
    Exec("../test/p2", sizeof("../test/p2")/sizeof(char));
    Yield();
    Exec("../test/p2", sizeof("../test/p2")/sizeof(char));
    Exit(0);
