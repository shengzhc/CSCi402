...
Thread::Thread(char* threadName)
{
    ...
    threadinfo->childThreadsCount = 0;
    threadinfo->parentThread = currentThread;
    threadinfo->tid = -1;
    threadinfo->threadLock = new Lock("");
    threadinfo->threadCV = new Condition("");
    threadinfo->isToExit = false;
#endif
}
